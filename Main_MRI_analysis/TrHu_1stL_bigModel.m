function mri = TrHu_1stL_big_model(mri)
% model with ESD(d-1), delta-ES, urgency, and total current evidence

analysis_num = 'big_model_with_totev';
...
for b=1:mri.nblocks
    ...
    %% total ev (current): only for PPI, comment out otherwise 
