%% Script to change mri.epi_dirs to the correct smoothed .nii file
...
for i = 18:length(files)
    ...
    for b = 1:4
        mri.epi_dirs{b} = ['swusub-' num2str(subject) '_run-' num2str(b) '_TrHu-bold.nii']

    end 

    save([num2str(subject) '.mat'], 'mri')
