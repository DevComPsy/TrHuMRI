...
%% general setup
res_dir = ['D:\Observational Study\Information_gathering-main\Analysis\1stL\' analysis_num '\' num2str(mri.ID) '\'];
mkdir(res_dir);
%general functions
...
for m = 1:mri.nblocks
    ...
    path_to_move_params{m} =  {['D:\Observational Study\Information_gathering-main\Analysis\sub-' num2str(mri.ID)...
