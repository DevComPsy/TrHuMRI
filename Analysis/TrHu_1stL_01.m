...
%% general setup
res_dir = ['D:\InformationGatheringMRI\derivatives\sub-' num2str(mri.ID) '\1stL\' analysis_num  '\'];
...
for m = 1:mri.nblocks
    scans{m,1} = ['D:\InformationGatheringMRI\derivatives\sub-' num2str(mri.ID) '\func\' mri.epi_dirs{m}];
